...
import PythonTab from '../python-tab/python-tab.jsx';
...
const CPP_TEMPLATE = `//This c++ code is generated by PictoBlox
...
function convertBlocksToCpp (vm, board) {
    ...
    // Collect pins that need implicit pinMode (like PictoBlox does)
    ...
    var code = '//This c++ code is generated by PictoBlox\n\n';
    if (servoPins.size > 0) {
